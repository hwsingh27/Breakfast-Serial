/**
 * @file: cbuff_test.c
 * @brief: testing of circular buffer is performed in this file
 * to make circular buffers solid for working with the UART.
 * Asserts are used to give the failure message at that line.
 *
 * @author: Harshwardhan Singh, harshwardhan.singh@colorado.edu
 * @date: 8th November 2021
 * @references/citations: Prof. Howdy Pierce's test suit shared by him
